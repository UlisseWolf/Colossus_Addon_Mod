...
----------------------------------------------------
special_buildings.DeluxePoliceStationMZ = hex2dec('b3860000')
...
---------------------------------------------
a = create_reward_cityplanning('b3860000') -- The hex number matches the Building Exemplar IID
...
s.reward_guid  = hex2dec('b3860000') -- MZ Deluxe Police Station
