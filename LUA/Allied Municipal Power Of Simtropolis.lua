--#-package:b03c81b3# -- package signature
...
generator_hex_id = {
   DIESEL_945_KW              = "B694726D",   ---PEG-MTP LT Generator---OG_ID 0xBB352003---
   NAT_GAS_180_KW             = "AEA950C4",   ---Stromgenerator---OG_ID 0xBB352100---
   PV_PANEL_SET_25_KW         = "490FF4A1"    ---Modular Solar Panels---OG_ID 0xBB350010---
}
transformer_hex_id = {
   COM_1_5_MVA_1              = "2D2F5802",   ---KK_Transformers_COM_1_5MVA---OG_ID 0xBB350024---
   COM_1_5_MVA_2              = "ED2F5742",   ---KK_Transformers_COM_1_5MVA---OG_ID 0xBB350024---
   COM_1_5_MVA_3              = "ED2F5567",   ---KK_Transformers_COM_1_5MVA---OG_ID 0xBB350024---
   COM_1_5_MVA_4              = "6D2F54B6",   ---KK_Transformers_COM_1_5MVA---OG_ID 0xBB350024---
   COM_1_5_MVA_5              = "2D2F5915",   ---KK_Transformers_COM_1_5MVA---OG_ID 0xBB350024---
   COM_1_5_MVA_6              = "CD2F58C3",   ---KK_Transformers_COM_1_5MVA---OG_ID 0xBB350024---
   COM_1_5_MVA_7              = "0D318080",   ---KK_Transformers_COM_1_5MVA---OG_ID 0xBB350024---
   IND_3_MVA_1                = "CD30721B",   ---KK_Transformers_IND_3MVA---OG_ID 0xBB350025---
   IND_3_MVA_2                = "8D307337",   ---KK_Transformers_IND_3MVA---OG_ID 0xBB350025---
   IND_3_MVA_3                = "CD3075B4",   ---KK_Transformers_IND_3MVA---OG_ID 0xBB350025---
   IND_3_MVA_4                = "CD30783B",   ---KK_Transformers_IND_3MVA---OG_ID 0xBB350025---
   IND_3_MVA_5                = "4D30792F",   ---KK_Transformers_IND_3MVA---OG_ID 0xBB350025---
   IND_3_MVA_6                = "6D3079AF",   ---KK_Transformers_IND_3MVA---OG_ID 0xBB350025---
   IND_6_MVA_1                = "AD302940",   ---KK_Transformers_IND_6MVA---OG_ID 0xBB350026---
   IND_6_MVA_2                = "0D302A1A",   ---KK_Transformers_IND_6MVA---OG_ID 0xBB350026---
   IND_6_MVA_3                = "0D302A6A",   ---KK_Transformers_IND_6MVA---OG_ID 0xBB350026---
   IND_6_MVA_4                = "4D2F4E98",   ---KK_Transformers_IND_6MVA---OG_ID 0xBB350026---
   IND_6_MVA_5                = "4D2F51DA",   ---KK_Transformers_IND_6MVA---OG_ID 0xBB350026---
   IND_6_MVA_6                = "AD2F5322",   ---KK_Transformers_IND_6MVA---OG_ID 0xBB350026---
   IND_6_MVA_7                = "0D2F4F4B",   ---KK_Transformers_IND_6MVA---OG_ID 0xBB350026---
   IND_6_MVA_8                = "CD3098FD"    ---KK_Transformers_IND_6MVA---OG_ID 0xBB350026---
}
...
transmission_station_hex_id = {
   ...
   MVA_10_2                   = "8D5A5227",   
   MVA_10_3                   = "CD5A5243",   
   MVA_20                     = "51576A9A",   ---Homefryes Substation 1---OG_ID 0xBB350121---
   MVA_35                     = "F157688B",   ---Homefryes Substation 2---OG_ID 0xBB350122---
   MVA_60                     = "578642C5",   ---SM2 Power Transformer 3---OG_ID 0xBB350123---
   MVA_60_S                   = "D77FEB63",   ---SM2 Power Substation---OG_ID 0xBB350124---
   MVA_90                     = "115765A1",   ---Homefryes Substation 3---OG_ID 0xBB350125---
   MVA_120                    = "F156F351"    ---Homefryes Substation 4---OG_ID 0xBB350126---
}
elec_feature_hex_id = {
   ...
   STEP_UP_TRANSFORMER_3_3_MW = "A90B4E29",   ---SM2 Step up Transformer---OG_ID 0xBB35014E---
   INVERTER_410_KW            = "B90B4DC3"    ---SM2 Step up Transformer---OG_ID 0xBB35014E---
}
power_plant_hex_id = {
   ---SOLAR---
   SOLAR_POWER_PLANT_370_KW   = "690A0D1A",   ---SM2 GE Solar Power Plant---OG_ID 0xBB350150---
   SOLAR_THERMAL_PLANT_2_5_MW = "B031EC3E",   ---Maxis Solar Power Plant---OG_ID 0xBB350151---
   ---WIND---
   WIND_TURBINE_1_MW          = "024059E9",   ---Maxis Wind Power Plant---OG_ID 0xBB350160---
   ---TIDAL---
   ---COAL---
   COAL_2_MW                  = "DFCF65CD",   ---Chicago Union Station Power Plant---OG_ID 0xBB3501C0---
   COAL_10_MW                 = "E0C896CC",   ---Maxis Coal Power Plant---OG_ID BB3500C0---
   ...
   ---BIOMASS---
   ---FISSION---
   FISSION_25_MW              = "055D65AE",   ---Maxis Fission Power Plant---OG_ID 0xBB350078---
   FISSION_1_2_GW             = "542CA54B",   ---BurroDiablo Nuclear Power Plant---OG_ID 0xBB350080---
   ---FUSION---
   FUSION_75_MW               = "78A0F71A",   ---Maxis Fusion Power Plant---OG_ID 0xBB350088---
   ---GEOTHERMAL---
   ...
   ---HYDROELECTRIC---
   ---OIL---
   OIL_15_MW                  = "46DF0D2F",   ---Maxis Oil Power Plant---OG_ID 0xBB350090---
   ---NATURAL GAS---
   NAT_GAS_6_5_MW             = "C9FBC2CD",   ---Maxis Gas Power Plant---OG_ID 0xBB3501A4---
...
-- 000 through 01F = Generators -- Generators do not have kVA ratings as they output Houshold voltage and thus their power can be used directly without transformers or substations.
   ...
   ID_BB35008E = 0,
   ID_BB35008F = 0,
   ID_BB350090 = 30000,   --Large Oil Plants--
   ID_BB350091 = 37500,
   ID_BB350092 = 0,
   ID_BB350093 = 0,
   ID_BB350094 = 0,
...
company_name = {
   EID_00 = "Allied Municipal Power of Simtropolis",    ---UNCONFIRMED---
   EID_01 = "Maxis Corporation",                        ---CONFIRMED---
   EID_02 = "BSC Incorporated",                         ---CONFIRMED---
   EID_03 = "SM2 HeavyStuff Industries",                ---CONFIRMED---
   EID_04 = "Kloudkicker Industries",                   ---CONFIRMED---
   EID_05 = "PEGPROD Global Aesthetics",                ---CONFIRMED---
   EID_06 = "Petrochem",                                ---CONFIRMED---
   EID_07 = "Colyn Power Products",                     ---UNCONFIRMED---
   EID_08 = "Deadwood Construction",                    ---UNCONFIRMED---
   EID_09 = "DK1 Electric Concepts",                    ---UNCONFIRMED---
   EID_0A = "Fukuda Corporation",                       ---UNCONFIRMED---
   EID_0B = "Homefryes Electronics",                    ---UNCONFIRMED---
   EID_0C = "JPouX International Power",                ---UNCONFIRMED---
   EID_0D = "Kaos Home Power Systems",                  ---UNCONFIRMED---
   EID_0E = "",
   EID_0F = "Mathe Man GeoIndustries",                  ---UNCONFIRMED---
   EID_10 = "",
   EID_11 = "Mr. Bison M and Associates",               ---UNCONFIRMED---
   EID_12 = "Onlyplace4 Electric Power",                ---UNCONFIRMED---
   EID_13 = "",                       
   EID_14 = "Shortman 123 Motors",                      ---UNCONFIRMED---
   EID_15 = "Shydude Electric",                         ---UNCONFIRMED---
   EID_16 = "",                     
   EID_17 = "",
   EID_18 = "Subgrav Holdings Inc.",                    ---UNCONFIRMED---
   EID_19 = "Taking You There Machinery",               ---UNCONFIRMED---
   EID_1A = "",
   EID_1B = "",
   EID_1C = "",
   EID_1D = "",
...
grid_logic_var ={
   ...
   LARGE_WASTE_COUNT     = 0,
   LARGE_HYDRO_COUNT     = 0,
   LARGE_SPECIAL_B_COUNT = 0,
   LARGE_OTHER_B_COUNT   = 0,
   LARGE_OIL_COUNT       = 0,
   LARGE_NAT_GAS_COUNT   = 0,
   LARGE_MICRO_COUNT     = 0,
   LARGE_SPECIAL_P_COUNT = 0,
   ...
   SMALL_WASTE_COUNT     = 0,
   SMALL_HYDRO_COUNT     = 0,
   SMALL_SPECIAL_B_COUNT = 0,
   SMALL_OTHER_B_COUNT   = 0,
   SMALL_OIL_COUNT       = 0,
   SMALL_NAT_GAS_COUNT   = 0,
   SMALL_MICRO_COUNT     = 0,
   SMALL_SPECIAL_P_COUNT = 0,
   ...
   LARGE_WIND_RATING      = 0,
   LARGE_TIDAL_RATING     = 0,
   LARGE_SPECIAL_I_RATING = 0,
   LARGE_OTHER_I_RATING   = 0,
   LARGE_COAL_RATING      = 0,
   LARGE_BIO_RATING       = 0,
   LARGE_FISSION_RATING   = 0,
   LARGE_FUSION_RATING    = 0,
   LARGE_GEO_RATING       = 0,
   LARGE_WASTE_RATING     = 0,
   LARGE_HYDRO_RATING     = 0,
   LARGE_SPECIAL_B_RATING = 0,
   LARGE_OTHER_B_RATING   = 0,
   LARGE_OIL_RATING       = 0,
   LARGE_NAT_GAS_RATING   = 0,
   LARGE_MICRO_RATING     = 0,
   LARGE_SPECIAL_P_RATING = 0,
   LARGE_OTHER_P_RATING   = 0,
   MISC_ELEC_F_RATING     = 0,
   SMALL_SOLAR_RATING     = 0,
   SMALL_WIND_RATING      = 0,
   SMALL_TIDAL_RATING     = 0,
   SMALL_SPECIAL_I_RATING = 0,
   SMALL_OTHER_I_RATING   = 0,
   SMALL_COAL_RATING      = 0,
   SMALL_BIO_RATING       = 0,
   SMALL_FISSION_RATING   = 0,
   SMALL_FUSION_RATING    = 0,
   SMALL_GEO_RATING       = 0,
   SMALL_WASTE_RATING     = 0,
   SMALL_HYDRO_RATING     = 0,
   SMALL_SPECIAL_B_RATING = 0,
   SMALL_OTHER_B_RATING   = 0,
   SMALL_OIL_RATING       = 0,
   SMALL_NAT_GAS_RATING   = 0,
   SMALL_MICRO_RATING     = 0,
   SMALL_SPECIAL_P_RATING = 0,
   SMALL_OTHER_P_RATING   = 0,
...
-- Total Count of each grid section by type --
    ...
    grid_logic_var.LARGE_TIDAL_COUNT     = (0)
    grid_logic_var.LARGE_SPECIAL_I_COUNT = (0)
    ...
    grid_logic_var.LARGE_BIO_COUNT       = (sc4game.automata.get_source_building_count(hex2dec("BB3500B0")) + sc4game.automata.get_source_building_count(hex2dec("BB3500B1")) + sc4game.automata.get_source_building_count(hex2dec("BB3500B2")) + sc4game.automata.get_source_building_count(hex2dec("BB3500B3")) + sc4game.automata.get_source_building_count(hex2dec("BB3500B4")) + sc4game.automata.get_source_building_count(hex2dec("BB3500B5")) + sc4game.automata.get_source_building_count(hex2dec("BB3500B6")) + sc4game.automata.get_source_building_count(hex2dec("BB3500B7")))
    grid_logic_var.LARGE_FISSION_COUNT   = (sc4game.automata.get_source_building_count(hex2dec("BB350078")) + sc4game.automata.get_source_building_count(hex2dec("BB350080")))
    grid_logic_var.LARGE_FUSION_COUNT    = (sc4game.automata.get_source_building_count(hex2dec("BB350088"))) 
    ...
    grid_logic_var.LARGE_SPECIAL_B_COUNT = (0)
    ...
    grid_logic_var.LARGE_MICRO_COUNT     = (0)
    grid_logic_var.LARGE_SPECIAL_P_COUNT = (0)
    ...
    grid_logic_var.SMALL_TIDAL_COUNT     = (0)    
    grid_logic_var.SMALL_SPECIAL_I_COUNT = (0)	
    ...
    grid_logic_var.SMALL_SPECIAL_B_COUNT = (0)
    ...
    grid_logic_var.SMALL_MICRO_COUNT     = (0)   
	grid_logic_var.SMALL_SPECIAL_P_COUNT = (0)    
    ...
    grid_logic_var.LARGE_INTERM_COUNT  = (grid_logic_var.LARGE_SOLAR_COUNT   + grid_logic_var.LARGE_WIND_COUNT    + grid_logic_var.LARGE_TIDAL_COUNT    + grid_logic_var.LARGE_OTHER_I_COUNT + grid_logic_var.LARGE_SPECIAL_I_COUNT)
    grid_logic_var.LARGE_BASE_COUNT    = (grid_logic_var.LARGE_GEO_COUNT     + grid_logic_var.LARGE_BIO_COUNT     + grid_logic_var.LARGE_FISSION_COUNT  + grid_logic_var.LARGE_FUSION_COUNT  + grid_logic_var.LARGE_COAL_COUNT   + grid_logic_var.LARGE_WASTE_COUNT + grid_logic_var.LARGE_HYDRO_COUNT  + grid_logic_var.LARGE_OTHER_B_COUNT + grid_logic_var.LARGE_SPECIAL_B_COUNT)
    grid_logic_var.LARGE_PEAK_COUNT    = (grid_logic_var.LARGE_MICRO_COUNT   + grid_logic_var.LARGE_OIL_COUNT     + grid_logic_var.LARGE_NAT_GAS_COUNT  + grid_logic_var.LARGE_OTHER_P_COUNT + grid_logic_var.LARGE_SPECIAL_P_COUNT)
    grid_logic_var.SMALL_INTERM_COUNT  = (grid_logic_var.SMALL_SOLAR_COUNT   + grid_logic_var.SMALL_WIND_COUNT    + grid_logic_var.SMALL_TIDAL_COUNT    + grid_logic_var.SMALL_OTHER_I_COUNT + grid_logic_var.SMALL_SPECIAL_I_COUNT)
    grid_logic_var.SMALL_BASE_COUNT    = (grid_logic_var.SMALL_GEO_COUNT     + grid_logic_var.SMALL_BIO_COUNT     + grid_logic_var.SMALL_FISSION_COUNT  + grid_logic_var.SMALL_FUSION_COUNT  + grid_logic_var.SMALL_COAL_COUNT   + grid_logic_var.SMALL_WASTE_COUNT + grid_logic_var.SMALL_HYDRO_COUNT  + grid_logic_var.SMALL_OTHER_B_COUNT + grid_logic_var.SMALL_SPECIAL_B_COUNT)
    grid_logic_var.SMALL_PEAK_COUNT    = (grid_logic_var.SMALL_MICRO_COUNT   + grid_logic_var.SMALL_OIL_COUNT     + grid_logic_var.SMALL_NAT_GAS_COUNT  + grid_logic_var.SMALL_OTHER_P_COUNT + grid_logic_var.SMALL_SPECIAL_P_COUNT)
...
-- Total kVA of each grid section by type --
    ...
    grid_logic_var.LARGE_TIDAL_RATING     = (0)
	...
	grid_logic_var.LARGE_SPECIAL_I_RATING = (0)
	--- Large Base ---
    ...
    grid_logic_var.LARGE_SPECIAL_B_RATING = (0)
    ...
    grid_logic_var.LARGE_MICRO_RATING     = (0)
	grid_logic_var.LARGE_SPECIAL_P_RATING = (0)        
    ...
    grid_logic_var.SMALL_TIDAL_RATING     = (0)
	grid_logic_var.SMALL_SPECIAL_I_RATING = (0)
    ...
    grid_logic_var.SMALL_SPECIAL_B_RATING = (0)
    ...
    grid_logic_var.SMALL_MICRO_RATING     = (0)
	grid_logic_var.SMALL_SPECIAL_P_RATING = (0)        
    ...
    grid_logic_var.LARGE_I_RATING      = (grid_logic_var.LARGE_SOLAR_RATING  + grid_logic_var.LARGE_WIND_RATING   + grid_logic_var.LARGE_TIDAL_RATING  + grid_logic_var.LARGE_SPECIAL_I_RATING  + grid_logic_var.LARGE_OTHERI_RATING) -- Total kVA of all large Intermediate power plants --
    grid_logic_var.LARGE_B_RATING      = (grid_logic_var.LARGE_COAL_RATING   + grid_logic_var.LARGE_BIO_RATING    + grid_logic_var.LARGE_FUSION_RATING + grid_logic_var.LARGE_FISION_RATING     + grid_logic_var.LARGE_GEO_RATING   + grid_logic_var.LARGE_WASTE_RATING + grid_logic_var.LARGE_HYDRO_RATING + grid_logic_var.LARGE_SPECIAL_B_RATING + grid_logic_var.LARGE_OTHERB_RATING) -- Total kVA of all large Base power plants --
    grid_logic_var.LARGE_P_RATING      = (grid_logic_var.LARGE_OIL_RATING    + grid_logic_var.LARGE_NATGAS_RATING + grid_logic_var.LARGE_MICRO_RATING  + grid_logic_var.LARGE_SPECIAL_P_RATING  + grid_logic_var.LARGE_OTHERP_RATING) -- Total kVA of all large Peak power plants --
    grid_logic_var.SMALL_I_RATING      = (grid_logic_var.SMALL_SOLAR_RATING  + grid_logic_var.SMALL_WIND_RATING   + grid_logic_var.SMALL_TIDAL_RATING  + grid_logic_var.SMALL_SPECIAL_I_RATING  + grid_logic_var.SMALL_OTHERI_RATING) -- Total kVA of all small Intermediate power plants --
    grid_logic_var.SMALL_B_RATING      = (grid_logic_var.SMALL_COAL_RATING   + grid_logic_var.SMALL_BIO_RATING    + grid_logic_var.SMALL_FUSION_RATING + grid_logic_var.SMALL_FISION_RATING     + grid_logic_var.SMALL_GEO_RATING   + grid_logic_var.SMALL_WASTE_RATING + grid_logic_var.SMALL_HYDRO_RATING + grid_logic_var.SMALL_SPECIAL_B_RATING + grid_logic_var.SMALL_OTHERB_RATING) -- Total kVA of all small Base power plants --
    grid_logic_var.SMALL_P_RATING      = (grid_logic_var.SMALL_OIL_RATING    + grid_logic_var.SMALL_NATGAS_RATING + grid_logic_var.SMALL_MICRO_RATING  + grid_logic_var.SMALL_SPECIAL_P_RATING  + grid_logic_var.SMALL_OTHERP_RATING) -- Total kVA of all small Peak power plants --
...
-- Total MWh of each grid section by type --
    ...
    grid_logic_var.L_TIDAL_POWER         = (0)
	grid_logic_var.L_SPECIAL_I_POWER     = (0)
    ...
    grid_logic_var.L_BIO_POWER           = ((sc4game.automata.get_source_building_count(hex2dec("BB3500B0"))*mwh_rating.ID_BB3500B0) + (sc4game.automata.get_source_building_count(hex2dec("BB3500B1"))*mwh_rating.ID_BB3500B1) + (sc4game.automata.get_source_building_count(hex2dec("BB3500B2"))*mwh_rating.ID_BB3500B2) + (sc4game.automata.get_source_building_count(hex2dec("BB3500B3"))*mwh_rating.ID_BB3500B3) + (sc4game.automata.get_source_building_count(hex2dec("BB3500B4"))*mwh_rating.ID_BB3500B4) + (sc4game.automata.get_source_building_count(hex2dec("BB3500B5"))*mwh_rating.ID_BB3500B5) + (sc4game.automata.get_source_building_count(hex2dec("BB3500B6"))*mwh_rating.ID_BB3500B6) + (sc4game.automata.get_source_building_count(hex2dec("BB3500B7"))*mwh_rating.ID_BB3500B7))
    grid_logic_var.L_FISSION_POWER       = ((sc4game.automata.get_source_building_count(hex2dec("BB350078"))*mwh_rating.ID_BB350078) + (sc4game.automata.get_source_building_count(hex2dec("BB350080"))*mwh_rating.ID_BB350080))
    grid_logic_var.L_FUSION_POWER        = ((sc4game.automata.get_source_building_count(hex2dec("BB350088"))*mwh_rating.ID_BB350088))	
    ...
    grid_logic_var.L_SPECIAL_B_POWER     = (0)
    ...
    grid_logic_var.L_MICRO_POWER         = (0)
	grid_logic_var.L_SPECIAL_P_POWER     = (0)        
    ...
    grid_logic_var.S_TIDAL_POWER         = (0)
	grid_logic_var.S_SPECIAL_I_POWER     = (0)
	...
	grid_logic_var.S_SPECIAL_B_POWER     = (0)
    ...
    grid_logic_var.S_MICRO_POWER         = (0)
    grid_logic_var.S_SPECIAL_P_POWER     = (0)     
    ...
    grid_logic_var.LARGE_I_POWER       = (grid_logic_var.L_SOLAR_POWER       + grid_logic_var.L_WIND_POWER        + grid_logic_var.L_TIDAL_POWER       + grid_logic_var.L_SPECIAL_I_POWER + grid_logic_var.L_OTHER_I_POWER)
    grid_logic_var.LARGE_B_POWER       = (grid_logic_var.L_COAL_POWER        + grid_logic_var.L_BIO_POWER         + grid_logic_var.L_FISSION_POWER     + grid_logic_var.L_FUSION_POWER    + grid_logic_var.L_GEOTHERMAL_POWER + grid_logic_var.L_WASTE_POWER + grid_logic_var.L_HYDRO_POWER + grid_logic_var.L_SPECIAL_B_POWER + grid_logic_var.L_OTHER_B_POWER)
    grid_logic_var.LARGE_P_POWER       = (grid_logic_var.L_OIL_POWER         + grid_logic_var.L_NAT_GAS_POWER     + grid_logic_var.L_MICRO_POWER       + grid_logic_var.L_SPECIAL_P_POWER + grid_logic_var.L_OTHER_P_POWER)
    grid_logic_var.SMALL_I_POWER       = (grid_logic_var.S_SOLAR_POWER       + grid_logic_var.S_WIND_POWER        + grid_logic_var.S_TIDAL_POWER       + grid_logic_var.S_SPECIAL_I_POWER + grid_logic_var.S_OTHER_I_POWER)
    grid_logic_var.SMALL_B_POWER       = (grid_logic_var.S_COAL_POWER        + grid_logic_var.S_BIO_POWER         + grid_logic_var.S_FISSION_POWER     + grid_logic_var.S_FUSION_POWER    + grid_logic_var.S_GEOTHERMAL_POWER + grid_logic_var.S_WASTE_POWER + grid_logic_var.S_HYDRO_POWER + grid_logic_var.S_SPECIAL_B_POWER + grid_logic_var.S_OTHER_B_POWER)
    grid_logic_var.SMALL_P_POWER       = (grid_logic_var.S_OIL_POWER         + grid_logic_var.S_NAT_GAS_POWER     + grid_logic_var.S_MICRO_POWER       + grid_logic_var.S_SPECIAL_P_POWER + grid_logic_var.S_OTHER_P_POWER)
...
-- Calculates the difference bewteen actual and ideal power generation. Used to account for both Unsuported Power Plants as well as power plant degradation over time
    ...
    grid_logic_var.D_TIDAL_POWER       = ((grid_logic_var.L_TIDAL_POWER         + grid_logic_var.S_TIDAL_POWER)         + (grid_logic_var.DEV_I_POWER        * ((grid_logic_var.L_TIDAL_POWER         + grid_logic_var.S_TIDAL_POWER)         / math.max(grid_logic_var.SUP_GEN_I_POWER,1))))
    grid_logic_var.D_SPECIAL_I_POWER   = ((grid_logic_var.L_SPECIAL_I_POWER     + grid_logic_var.S_SPECIAL_I_POWER)     + (grid_logic_var.DEV_I_POWER        * ((grid_logic_var.L_SPECIAL_I_POWER     + grid_logic_var.S_SPECIAL_I_POWER)     / math.max(grid_logic_var.SUP_GEN_I_POWER,1))))
    ...
    grid_logic_var.D_BIO_POWER         = ((grid_logic_var.L_BIO_POWER           + grid_logic_var.S_BIO_POWER)           + (grid_logic_var.DEV_B_POWER        * ((grid_logic_var.L_BIO_POWER           + grid_logic_var.S_BIO_POWER)           / math.max(grid_logic_var.SUP_GEN_B_POWER,1))))
    ...
    grid_logic_var.D_SPECIAL_B_POWER   = ((grid_logic_var.L_SPECIAL_B_POWER     + grid_logic_var.S_SPECIAL_B_POWER)     + (grid_logic_var.DEV_B_POWER        * ((grid_logic_var.L_SPECIAL_B_POWER     + grid_logic_var.S_SPECIAL_B_POWER)     / math.max(grid_logic_var.SUP_GEN_B_POWER,1))))
    ...
    grid_logic_var.D_MICRO_POWER       = ((grid_logic_var.L_MICRO_POWER         + grid_logic_var.S_MICRO_POWER)         + (grid_logic_var.DEV_P_POWER        * ((grid_logic_var.L_MICRO_POWER         + grid_logic_var.S_MICRO_POWER)         / math.max(grid_logic_var.SUP_GEN_P_POWER,1))))    
	grid_logic_var.D_SPECIAL_P_POWER   = ((grid_logic_var.L_SPECIAL_P_POWER     + grid_logic_var.S_SPECIAL_P_POWER)     + (grid_logic_var.DEV_P_POWER        * ((grid_logic_var.L_SPECIAL_P_POWER     + grid_logic_var.S_SPECIAL_P_POWER)     / math.max(grid_logic_var.SUP_GEN_P_POWER,1))))       
